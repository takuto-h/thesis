...
メソッドを定義する．
図\ref{figure:class-model}は，メソッド定義を行うRubyコードを例にメソッド定義のモデルを
示したものである．
...
このモデルにおいてはクラス名とクラスを対応付ける\textbf{クラス環境}にクラスを定義し，クラスにメソッドを定義する．
図\ref{figure:class-model}ではクラス環境からクラス名AおよびBによってラベル付けされたエッジがクラスへと伸び，
