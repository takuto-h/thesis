...
%\setlengthここに序論を書く．{\textheight}{10.1in}
...
オブジェクトシステムとは，\textbf{オブジェクト指向プログラミング}
\cite{Stroustrup:1988:OP:624569.624721}を支援する
プログラミング言語の機構である．
本研究は従来のオブジェクトシステムに対する分析によって考案した
新しいモデルに基づくオブジェクトシステムを提案する．
従来とは異なるモデルを示すことで，オブジェクトシステムにまつわる
既存の概念に対し新たな見方を提供することが目的である．
