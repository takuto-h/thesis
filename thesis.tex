...
変数定義を記述したブロックや関数・メソッド内でのみ参照可能なローカル変数の
有用性は広く認められており，ほとんどのオブジェクト指向言語がサポートしている．
同じように，ローカル変数のメソッド版としてローカルメソッドが定義できれば
有用だと考えられるが，ローカルメソッドをサポートするオブジェクト指向言語は
著者の知る限り存在しない．

そこで，本研究はローカルメソッドをサポートするオブジェクト指向言語の設計手法
を提案する．

\section{従来のオブジェクト指向言語}

従来のオブジェクト指向言語はローカル変数を定義することができるが，
ローカルメソッドを定義することはできない．

変数の場合，ブロックや関数・メソッド内でのみ参照可能なローカル変数を
定義することができる．例えばC++やJavaでは
